...
class EarlyStopping(Callback):
    ...
    def __init__(self, monitor: str = 'early_stop_on', min_delta: float = 0.0, patience: int = 3,
                 verbose: bool = False, mode: str = 'auto', strict: bool = True, restore_best_weights: bool = False):
        super().__init__()
    ...
    def _run_early_stopping_check(self, trainer, pl_module):
        ...
        if self.monitor_op(current - self.min_delta, self.best_score):
            ...
            self.wait_count = 0
            if self.restore_best_weights and trainer.is_global_zero:
                self._best_weights = trainer.model.model_weights()
            ...
            elif self.restore_best_weights and trainer.is_global_zero:
                trainer.model.load_weights(self._best_weights)
